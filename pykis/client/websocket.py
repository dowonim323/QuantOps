...
class KisWebsocketClient:
    ...
    def on_domestic_index_price(
        ...
        index: str,
        callback: Callable[
            ["KisWebsocketClient", KisSubscriptionEventArgs["KisRealtimeIndexPrice"]],
            None,
        ],
        where: KisEventFilter[
            "KisWebsocketClient", KisSubscriptionEventArgs["KisRealtimeIndexPrice"]
        ]
        | None = None,
        once: bool = False,
        ...
        from pykis.api.websocket.index import on_domestic_index_price as _on_index_price

        return _on_index_price(
            self,
            index=index,
            callback=callback,
            where=where,
