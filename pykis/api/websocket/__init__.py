from pykis.api.websocket.index import KisDomesticRealtimeIndexPrice
from pykis.api.websocket.market_status import KisDomesticMarketStatus
...
WEBSOCKET_RESPONSES_MAP: dict[str, type[KisWebsocketResponse]] = {
    ...
    "H0UPCNT0": KisDomesticRealtimeIndexPrice,
    ...
    "H0STMKO0": KisDomesticMarketStatus,
}
